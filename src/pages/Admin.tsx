    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 to-blue-50/30">
      ...
      <div className="container mx-auto px-4 py-6">
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 mb-8">
          {stats.map((stat, idx) => (
            <Card key={idx} className="border-0 shadow-sm rounded-2xl hover:shadow-md transition-all duration-200">
        ...
        <Tabs value={activeTab} onValueChange={setActiveTab} className="space-y-6">
          <TabsList className="grid w-full grid-cols-2 lg:grid-cols-4 p-1 bg-muted/50 rounded-xl h-auto gap-1">
            <TabsTrigger 
            ...
            >
              ...
              <span className="hidden sm:inline">User Queries</span>
              ...
              <CardHeader className="bg-gradient-to-r from-blue-50 to-indigo-50 pb-4">
                <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <CardTitle className="text-2xl">Partner Applications</CardTitle>
                          ...
                          <div className="flex flex-col lg:flex-row lg:items-start justify-between gap-4">
                            <div className="flex-1 space-y-3">
                              <div className="flex flex-col sm:flex-row sm:items-center gap-2">
                                ...
                                <Badge variant="outline" className="capitalize w-fit bg-blue-50 text-blue-700 border-blue-200">
                                  {app.type}
                                </Badge>
                              ...
                              <div className="grid grid-cols-1 sm:grid-cols-2 gap-2 text-sm">
                                ...
                                <div className="flex items-center gap-2">
                                  ...
                                  <span>{app.responsible?.name} • {app.responsible?.sex} • {app.responsible?.age}</span>
                                </div>
                              </div>
                              ...
                              <div className="flex gap-2 flex-wrap">
                                {app.passportPhoto && (
                                  <img 
                                    ...
                                    alt="passport" 
                                    className="h-12 w-12 object-cover rounded-lg cursor-pointer border hover:shadow-md transition-all"
                                ...
                                {app.certificateFile && (
                                  app.certificateFile.toLowerCase().endsWith('.pdf') ? (
                                    <a 
                                      ...
                                      target="_blank" 
                                      rel="noreferrer"
                                      className="flex items-center gap-2 px-3 py-2 border rounded-lg hover:bg-blue-50 transition-colors"
                                    >
                                      <FileText className="h-4 w-4" />
                                      Certificate PDF
                                    </a>
                            ...
                            <div className="flex flex-col sm:flex-row lg:flex-col gap-2">
                              <Button variant="outline" size="sm" onClick={() => openAppDialog(app)} className="flex items-center gap-2">
              ...
              <CardHeader className="bg-gradient-to-r from-orange-50 to-amber-50 pb-4">
                <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <CardTitle className="text-2xl">User Queries</CardTitle>
                      <CardDescription className="text-base">
                      ...
                      <Card key={query._id} className="border-muted-foreground/20 hover:shadow-md transition-all duration-200">
                        <CardContent className="p-4 sm:p-6">
                          <div className="flex flex-col lg:flex-row lg:items-start justify-between gap-4">
                            ...
                            <div className="flex flex-col sm:flex-row lg:flex-col gap-2">
                              <Button variant="outline" size="sm" onClick={() => viewQuery(query)} className="flex items-center gap-2">
                                <Eye className="h-4 w-4" />
                                View
                              </Button>
                              <Button 
            ...
            <Card className="border-0 shadow-lg rounded-2xl">
              <CardHeader className="bg-gradient-to-r from-green-50 to-emerald-50 pb-4">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <CardTitle className="text-2xl">Manage Partners</CardTitle>
                    <CardDescription className="text-base">
      ...
      <Dialog open={!!viewerImage} onOpenChange={(v) => { if (!v) setViewerImage(null); }}>
        <DialogContent className="max-w-4xl w-full">
          <DialogHeader>
            ...
            <DialogDescription>Enlarged view of the selected document</DialogDescription>
          </DialogHeader>
          <div className="flex justify-center items-center min-h-[60vh]">
            {viewerImage && (
              <img src={viewerImage} alt="preview" className="max-h-[60vh] max-w-full object-contain rounded-lg" />
            )}
          </div>
          <DialogFooter>
            <Button onClick={() => setViewerImage(null)} className="w-full sm:w-auto">Close Preview</Button>
          </DialogFooter>
        </DialogContent>
      </Dialog>

      {/* Query View Dialog (same as before) */}
        ...
        <DialogContent className="max-w-2xl w-full">
          ...
          {selectedQuery && (
            <div className="space-y-4 mt-2">
              {/* Query details content (same as before) */}
              <div className="space-y-1">
                <h3 className="font-semibold text-sm text-muted-foreground">Subject</h3>
                <div className="text-base">{selectedQuery.subject}</div>
              </div>
              <div className="space-y-1">
                <h3 className="font-semibold text-sm text-muted-foreground">Message</h3>
                <div className="text-base whitespace-pre-line bg-muted/30 p-3 rounded-lg">
                  {selectedQuery.message}
                </div>
              </div>
              <div className="space-y-1">
                <h3 className="font-semibold text-sm text-muted-foreground">User Details</h3>
                <div className="text-base">
              ...
              <DialogFooter className="flex flex-col sm:flex-row gap-2 pt-4">
                <Button variant="outline" onClick={() => { setViewDialogOpen(false); setSelectedQuery(null); }}>
                  Close
                </Button>
                <Button 
